...
func Benchmark_Parse(b *testing.B) {
	...
	tests := []struct {
		...
		// TODO: Add test cases.
		{"signed", &regValue{CfgRegister: spider.CfgRegister{Type: "signed"}}, args{[]byte{00, 01}}, int16(1), false},
		{"signed", &regValue{CfgRegister: spider.CfgRegister{Type: "signed"}}, args{[]byte{0xff, 01}}, int16(-255), false},
		{"unsigned", &regValue{CfgRegister: spider.CfgRegister{Type: "unsigned"}}, args{[]byte{00, 01}}, uint16(1), false},
		{"unsigned", &regValue{CfgRegister: spider.CfgRegister{Type: "unsigned"}}, args{[]byte{0xff, 01}}, uint16(65281), false},

		{"long", &regValue{CfgRegister: spider.CfgRegister{Type: "long"}}, args{[]byte{00, 01, 00, 02}}, int32(131073), false},
		{"long inverse", &regValue{CfgRegister: spider.CfgRegister{Type: "long", Inverse: true}}, args{[]byte{00, 01, 00, 02}}, int32(65538), false},
		{"signed", &regValue{CfgRegister: spider.CfgRegister{Type: "signed"}}, args{[]byte{0xff, 01}}, int16(-255), false},
	}
	for i := 0; i < b.N; i++ {
